    ...
    class UserController extends MY_Controller
    {
        ...
        public function create(){
            ...
            foreach ($group_system as $key => $value) {
                ...
                $list_group_system[$key]    = $this->recusive_lib->set_parent_to_array($temp);
                $list_group_system[$key]    = $this->recusive_lib->get_parent_to_array();
            }
        ...
        private function postCreate(){
            ...
            if ($this->form_validation->run('user_create')) {
                ...
                $arr_insert['password'] = md5($this->auth->suffix_pass.$input['Ppssword']);
